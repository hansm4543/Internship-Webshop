...
import { fetchProductsTech } from "../actions/productActions";
import Item from "./Item";
import './CategorieView.css';
import './SingleItem.css';
class ProductsTech extends Component {
  componentDidMount() {
    this.props.fetchProductsTech();
  }
  componentDidUpdate(){
...
export default connect(mapStateToProps, { fetchProductsTech, addToCart })(ProductsTech);
