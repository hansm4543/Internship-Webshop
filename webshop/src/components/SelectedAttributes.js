            ...
            if(this.props.attributes.type === "text"){
                if(length === 1){
                    return (
                        ...
                        <input  type="radio" id={this.props.attributes.items[0].value} name={this.props.attributes.name} value={this.props.attributes.items[0].displayValue}/>
                    ...
                    //tehtud
                    if(this.props.selectedAttribute !== undefined){
                        console.log(this.props.selectedAttribute)
                        if(this.props.selectedAttribute === this.props.attributes.items[1].displayValue){
                            return (
                        ...
                        return(
                            ...
                            <p>Please select {this.props.attributes.name}:</p>
                                ...
                                <label>
                                    <input className="textinput" defaultChecked id={this.props.attributes.items[0].value} type="radio" name={this.props.attributes.name} value={this.props.attributes.items[0].displayValue}></input>
                                    {this.props.attributes.items[0].displayValue}
                                </label>
                                <br></br>
                                <label>
                                    <input className="textinput" id={this.props.attributes.items[1].value} type="radio" name={this.props.attributes.name} value={this.props.attributes.items[1].displayValue}></input>
                                    {this.props.attributes.items[1].displayValue}
                                </label>
                ...
                if(length === 1){
                    ...
                    if(this.props.selectedAttribute !== undefined){
                        console.log("ns")
                        console.log(this.props.selectedAttribute)
                        if(this.props.selectedAttribute === this.props.attributes.items[4].displayValue){
                            return (
                                <div class="colors Attributes">
                            <br/>
                            <p>Please select {this.props.attributes.name}:</p>
